...
export const flowMedio_satisfaccion = addKeyword(EVENTS.ACTION).addAnswer('👉🏼 *2. ¿Podrías contarnos brevemente el motivo de tu puntaje?* 💬🤔\nSelecciona un número del *1 al 4* por favor.\n\n*1.* Buen desempeño del producto\n*2.* Atención adecuada.\n*3.* Entrega dentro del tiempo esperado.\n*4*. Precio razonable. \n\n📌 Si te equivocas en este paso, solo vuelve a escribir el número del *1 al 4* 😉', {capture: true, delay: 1000}, 
    async (ctx, ctxFn) => {
...
export const flowTerminado_satisfaccion = addKeyword(EVENTS.ACTION).addAnswer('💬 *¡Gracias por tu valioso tiempo!*\n\n Tu opinión es fundamental para que sigamos mejorando el soporte CVA que ofrecemos en tu operación en campo 💪🏼🛠️. \nAdemás, ¡Ya estás participando en el sorteo de una miniatura! 🎉\nContamos contigo para seguir avanzando.')